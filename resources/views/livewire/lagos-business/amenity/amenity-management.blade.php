<div class="container-fluid py-4">
    <div class="d-flex justify-content-between">
        <h5>Amenitys List</h5>
        <a href="{{ route('amenity-new') }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp;New
            Amenity</a>
    </div>
    <div class="row">
        <div class="col-12">
                        ...
                        <tbody>
                            <tr>
                                @foreach ($services as $key => $obj)
                                    ...
                                    <td>
                                        <a href="{{ route('amenity-edit', ['id' => $obj->id]) }}"
                                            class="mx-3" data-bs-toggle="tooltip"
                                            data-bs-original-title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <span>
                                            <i onclick="confirm('Are you sure you want to remove the amenity?') || event.stopImmediatePropagation()"
