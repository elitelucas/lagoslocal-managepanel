...
@section('content')
    ...
    <div class="hero_in detail_page background-image" data-background="url(user_assets/img/restaurant_detail_hero.jpg)">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-6">
                            <div class="buttons clearfix">
                                <span class="magnific-gallery">
                                    <a href="user_assets/img/detail_1.jpg" class="btn_hero" title="Photo title"
                                        data-effect="mfp-zoom-in"><i class="icon_image"></i>View photos</a>
                                    <a href="user_assets/img/detail_2.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
                                    <a href="user_assets/img/detail_3.jpg" title="Photo title" data-effect="mfp-zoom-in"></a>
                                </span>
                        ...
                        <div id="pane-A" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="tab-A">
                            ...
                            <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
                                <div class="card-body info_content">
                                    <p>Mei at intellegat reprehendunt, te facilisis definiebas dissentiunt usu. Choro
                                        delicata voluptatum cu vix. Sea error splendide at. Te sed facilisi persequeris
                                        definitiones, ad per scriptorem instructior, vim latine adipiscing no. Cu tacimates
                                        salutandi his, mel te dicant quodsi aperiri. Unum timeam his eu.</p>
                                    <p>An malorum ornatus nostrum vel, graece iracundia laboramus cu ius. No pro mazim
                                        blandit instructior, sumo voluptaria has et, vide persecuti abhorreant ne est.</p>
                                    <div class="add_bottom_25"></div>
                                    <h2>Pictures from our users</h2>
                                    <div class="pictures magnific-gallery clearfix">
                                        <figure><a href="user_assets/img/detail_gallery/detail_1.jpg" title="Photo title"
                                                data-effect="mfp-zoom-in"><img src="user_assets/img/thumb_detail_placeholder.jpg"
                                                    data-src="user_assets/img/thumb_detail_1.jpg" class="lazy" alt=""></a>
                                        </figure>
                                        <figure><a href="user_assets/img/detail_gallery/detail_2.jpg" title="Photo title"
                                                data-effect="mfp-zoom-in"><img src="user_assets/img/thumb_detail_placeholder.jpg"
                                                    data-src="user_assets/img/thumb_detail_2.jpg" class="lazy" alt=""></a>
                                        </figure>
                                        <figure><a href="user_assets/img/detail_gallery/detail_3.jpg" title="Photo title"
                                                data-effect="mfp-zoom-in"><img src="user_assets/img/thumb_detail_placeholder.jpg"
                                                    data-src="user_assets/img/thumb_detail_3.jpg" class="lazy" alt=""></a>
                                        </figure>
                                        <figure><a href="user_assets/img/detail_gallery/detail_4.jpg" title="Photo title"
                                                data-effect="mfp-zoom-in"><img src="user_assets/img/thumb_detail_placeholder.jpg"
                                                    data-src="user_assets/img/thumb_detail_4.jpg" class="lazy" alt=""></a>
                                        </figure>
                                        <figure><a href="user_assets/img/detail_gallery/detail_5.jpg" title="Photo title"
                                                data-effect="mfp-zoom-in"><span
                                                    class="d-flex align-items-center justify-content-center">+10</span><img
                                                    src="user_assets/img/thumb_detail_placeholder.jpg" data-src="user_assets/img/thumb_detail_5.jpg"
                                    ...
                                    <div class="menu_item">
                                        ...
                                        <p>Base de arroz, aguacate, salmón noruego, semillas de sésamo, edamame, wakame y
                                            soja light</p>
                                    </div>
                                    <div class="menu_item">
                                        <em>€7.90</em>
                                    ...
                                    <div class="menu_item">
                                        ...
                                        <p>lechuga, tomate, espinacas, pollo asado, picatostes, queso proteínico y salsa
                                            césar 0%</p>
                                    </div>
                                    <hr>
                                    <h3>Main Course</h3>
                                ...
                                <div class="card-body reviews">
                                    ...
                                    <div id="reviews">
                                        <div class="review_card">
                                            <div class="row">
                                                <div class="col-md-2 user_info">
                                                    <figure><img src="user_assets/img/avatar4.jpg" alt=""></figure>
                                                    <h5>Lukas</h5>
                                                </div>
                                                <div class="col-md-10 review_content">
                                                    ...
                                                    <p>Eos tollit ancillae ea, lorem consulatu qui ne, eu eros eirmod
                                                        ...
                                                        fuisset ut. Viderer petentium cu his. Tollit molestie suscipiantur
                                                        his et.</p>
                                                    <ul>
                                                        <li><a href="#0"><i
                                        ...
                                        <div class="review_card">
                                            <div class="row">
                                                <div class="col-md-2 user_info">
                                                    <figure><img src="user_assets/img/avatar6.jpg" alt=""></figure>
                                                    <h5>Lukas</h5>
                                                </div>
                                                <div class="col-md-10 review_content">
                                                    <div class="clearfix add_bottom_15">
                                        ...
                                        <div class="review_card">
                                            <div class="row">
                                                <div class="col-md-2 user_info">
                                                    <figure><img src="user_assets/img/avatar1.jpg" alt=""></figure>
                                                    <h5>Marika</h5>
                                                </div>
                                                <div class="col-md-10 review_content">
                                                    <div class="clearfix add_bottom_15">
                                            ...
                                            <div class="row reply">
                                                <div class="col-md-2 user_info">
                                                    <figure><img src="user_assets/img/avatar.jpg" alt=""></figure>
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="review_content">
                                                        <strong>Reply from Lagoslocal</strong>
                                                        <em>Published 3 minutes ago</em>
                                                        <p><br>Hi Monika,<br><br>Eos tollit ancillae ea, lorem consulatu qui
                                                            ne, eu eros eirmod scaevola sea. Et nec tantas accusamus
                                                            salutatus, sit commodo veritus te, erat legere fabulas has ut.
                                                            Rebum laudem cum ea, ius essent fuisset ut. Viderer petentium cu
                                                            his. Tollit molestie suscipiantur his et.<br><br>Thanks</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /reply -->
                                    ...
                                    <!-- /reviews -->
                                    <div class="text-right"><a href="leave-review.html" class="btn_1">Leave a
                                            review</a></div>
                                </div>
                            </div>
                        </div>
