    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('user-home') }}">
            ...
            @if (auth()->user()->isBusiness())
                <span class="ms-1 font-weight-bold">Business Panel</span>
            @endif
        </a>
    </div>
            ...
            @if (auth()->user()->isBusiness())
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#dashboardsExamples"
                        ...
                        <span class="nav-link-text ms-1">Manage Business</span>
                    </a>
                    <div class="collapse {{ strpos(Request::route()->uri(), 'lagos') === false ? '' : 'show' }}"
                        id="dashboardsExamples">
                        <ul class="nav ms-4 ps-3">
                            <li
                                class="nav-item {{ Route::currentRouteName() == 'businessinformation' ? 'active' : '' }}">
                                <a class="nav-link {{ Route::currentRouteName() == 'businessinformation' ? 'active' : '' }}"
                                    href="{{ route('businessinformation') }}">
                                    <span class="sidenav-mini-icon"> B </span>
                                    <span class="sidenav-normal"> Business Information </span>
                                </a>
                            </li>
                            <li class="nav-item {{ Route::currentRouteName() == 'review-list' ? 'active' : '' }}">
                                <a class="nav-link {{ Route::currentRouteName() == 'review-list' ? 'active' : '' }}"
                            ...
                            <li
                                class="nav-item {{ Route::currentRouteName() === 'product-management' ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item {{ Route::currentRouteName() === 'service-management' ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item {{ Route::currentRouteName() === 'amenity-management' ? 'active' : '' }}">
            ...
            @if (auth()->user()->isAdmin())
                <li class="nav-item">
                    ...
                    <div class="collapse {{ strpos(Request::route()->uri(), 'admin') === false ? '' : 'show' }}"
                        ...
                        <ul class="nav ms-4 ps-3">
                            <li
                                class="nav-item {{ Route::currentRouteName() === 'admin-business-list' ? 'active' : '' }}">
                                <a class="nav-link {{ Route::currentRouteName() === 'admin-business-list' ? 'active' : '' }}"
                                    href="{{ route('admin-business-list') }}">
                                    <span class="sidenav-mini-icon"> B </span>
                                    <span class="sidenav-normal"> All Businesses </span>
                                </a>
                            </li>
                            <li
            ...
            @if ($_SERVER['SERVER_NAME'] == '127.0.0.1' && 1 == 0)
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ strpos(Request::route()->uri(), 'pages') === false ? '' : 'show' }}"
                        ...
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item">
                                <a class="nav-link {{ !in_array(
                                    request()->route()->getName(),
                                    ['overview', 'all-projects', 'teams'],
                                )
                                    ? ''
                                    : 'active' }}"
